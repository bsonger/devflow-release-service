...
| `resource_id` | `ObjectID` | system-set | system | 目标资源 ID |
| `application_id` | `ObjectID` | system-set | system | 应用 ID |
| `application_name` | `string` | system-set | system | 应用名 |
| `manifest_id` | `*ObjectID` | optional | system | Manifest ID |
| `manifest_name` | `string` | optional | system | Manifest 名 |
| `release_id` | `*ObjectID` | optional | system | Release ID |
| `release_type` | `string` | optional | system | 发布类型 |
| `env` | `string` | optional | system | 目标环境 |
| `repo_url` | `string` | optional | system | 仓库地址 |
