...
func (s stubImageService) CreateImage(ctx context.Context, m *model.Image) (uuid.UUID, error) {
...
func (s stubImageService) Patch(ctx context.Context, id uuid.UUID, patch *model.PatchImageRequest) error {
...
func TestCreateImageReturnsEnvelope(t *testing.T) {
	...
	handler := &ImageHandler{
		svc: stubImageService{
			createFn: func(_ context.Context, m *model.Image) (uuid.UUID, error) {
				m.WithCreateDefault()
				m.Name = "image-main-1"
				return m.GetID(), nil
			},
...
func TestPatchImageNotFoundReturnsErrorEnvelope(t *testing.T) {
	...
	handler := &ImageHandler{
		svc: stubImageService{
			patchFn: func(_ context.Context, _ uuid.UUID, _ *model.PatchImageRequest) error {
