...
func (s stubReleaseManifestReader) Get(ctx context.Context, id uuid.UUID) (*model.Manifest, error) {
...
func TestCreateReleaseRejectsManifestThatIsNotReady(t *testing.T) {
	...
	releaseManifestSource = stubReleaseManifestReader{
		getFn: func(_ context.Context, id uuid.UUID) (*model.Manifest, error) {
